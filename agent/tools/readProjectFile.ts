...
/**
 * Repo access for the writing client's own projects, named `readProjectFile` because
...
export default defineTool({
  description: REPO_SPECS.readProjectFile.description,
  inputSchema: REPO_SPECS.readProjectFile.inputSchema,
  execute: async (input, ctx) => {
    ...
    const result = await createRepoTools(runtime.context, projects, activity).readProjectFile.execute!(
      input,
