...
/**
 * Repo access for the writing client's own projects, named `searchProjectCode` because
...
export default defineTool({
  description: REPO_SPECS.searchProjectCode.description,
  inputSchema: REPO_SPECS.searchProjectCode.inputSchema,
  execute: async (input, ctx) => {
    ...
    const result = await createRepoTools(runtime.context, projects, activity).searchProjectCode.execute!(
      input,
