...
- CONTINUES_PENDING: ההודעה עונה לשאלה על הפנייה שבתהליך עכשיו (אישור, תיקון, פרט שנשאל עליו). כשמצוין שיש סיכום שממתין לאישור והלקוח עונה תשובה קצרה - אישור ("כן", "מדויק") או תיקון - זה תמיד CONTINUES_PENDING, לעולם לא NEW.
